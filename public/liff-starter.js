...
function displayIsInClientInfo() {
    if (liff.isInClient()) {
        ...
        document.getElementById('isInClientMessage').textContent = 'Kamu lagi buka aplikasi nya dari Line';
    } else {
        document.getElementById('isInClientMessage').textContent = 'Kamu lagi buka aplikasi nya dari browser.';
...
function registerButtonHandlers() {
    ...
    document.getElementById('sendMessageButton').addEventListener('click', function () {
        if (!liff.isInClient()) {
            ...
            liff.sendMessages([{
                'type': 'text',
                'text': "Pesanan nya udah di kirim yah!"
            }]).then(function () {
                window.alert('Pesanan Terkirim');
            }).catch(function (error) {
                window.alert('Ups , ada yang salah nih di :' + error);
            });
        }
    });
...
function sendAlertIfNotInClient() {
    alert('Fitur ga bisa dijalankan , Kamu lagi buka app nya di browser eksternal');
}
